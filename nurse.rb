...
def open_csv(filename)
  ...
  CSV.foreach(filename, headers:true) do | row |
      ...
      patient = { :bed_no => bed_no, :hospital_no => hospital_no, :first_name => first_name, :last_name => last_name, :dob => dob, :age => age, :current_diagnosis => current_diagnosis}
...
def build_table(patients)
  ...
  table.headings = ['Bed Number', 'Hospital Number', 'First Name', 'Last Name', 'D.O.B', 'Age', 'Current Diagnosis']
  puts table
end
